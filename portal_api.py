...
<header class="top"><div class="logo"><div class="mark">RX</div><div><b>Raio-X Territorial</b><small>Inteligência rural</small></div></div><div class="search"><input id="q" placeholder="Fazenda, CAR ou cidade"><button id="go">Buscar</button></div><div class="status">● SISTEMA LIVE</div></header>
