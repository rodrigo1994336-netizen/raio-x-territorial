...
(function(){
 ...
 function auditStateLabel(state){return ({NOT_QUERIED:'NÃO CONSULTADA',QUERYING:'CONSULTANDO',ANSWERED_CLEAR:'RESPONDEU · SEM OCORRÊNCIA',ANSWERED_HIT:'RESPONDEU',BLOCKED:'BLOQUEADA',FAILED:'FONTE INDISPONÍVEL'})[state]||'ESTADO INVÁLIDO'}
