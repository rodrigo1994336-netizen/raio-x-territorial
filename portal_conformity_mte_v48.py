...
def _panel_sync_v48(car_code: str) -> dict[str, Any]:
    ...
    # Derive the original implemented cardinality from the actual original arrays,
...
print("RX_PORTAL_CONFORMITY_MTE_V48=original8_plus_mte_future7_audit_only_implemented11_truth_idempotent", flush=True)
