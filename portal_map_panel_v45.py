...
(function(){
 ...
 function panelHtml(p){
   ...
   const count=auditOk?`${audit.responded} de ${audit.total} fontes responderam nesta consulta`:(p.__rxAuditFailed?'Consulta às fontes oficiais pendente':'Consultando fontes oficiais…');
